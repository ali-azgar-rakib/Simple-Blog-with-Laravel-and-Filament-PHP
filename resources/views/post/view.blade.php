<x-app-layout>
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <div class="w-full flex pt-6">
            @if ($prev)
            <a href="{{ route('home.show',$prev->slug) }}" class="w-1/2 bg-white shadow hover:shadow-md text-left p-6">
            ...
            @endif
            @if ($next)
            <a href="{{ route('home.show',$next->slug) }}" class="w-1/2 bg-white shadow hover:shadow-md text-right p-6">
